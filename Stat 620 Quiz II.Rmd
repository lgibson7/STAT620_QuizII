...
$$X\sim Bin(n,p)$$
$$x\in S_X\space \space where \space \space S_X=\{{0,1,...n}\}$$
...
$$E(X)= M_X \space '(t)=\frac{d}{dt}(1-p+pe^t)^n=n(1-p+pe^t)^{n-1}\cdot (0-0+pe^t)$$
...
$$ M_X \space \space'' (t)=n\cdot p(1)+n(n-1) p^2(1)(1)$$
Such that
